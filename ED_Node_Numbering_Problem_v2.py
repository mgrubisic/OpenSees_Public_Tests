...
# node numbering "problematic" + constraints "zeroLengthSection     ==> results in correct periods/frequencies (T1 = 0.407 s)
# node numbering "problematic" + constraints "zeroLength"           ==> results in correct periods/frequencies (T1 = 0.407 s)
# node numbering "problematic" + constraints "twoNodeLink"          ==> results in correct periods/frequencies (T1 = 0.407 s)

# INCORRECT combinations
# ----------------------
# node numbering "problematic" + constraints "equalDOF"             ==> results in INCORRECT periods/frequencies (T1 = 0.167 s)
# node numbering "problematic" + constraints "rigidLink"            ==> results in INCORRECT periods/frequencies (T1 = 0.167 s)


# Node numbering
# --------------
nodeNumbering = "problematic" # "simple", "problematic"
...
elif nodeNumbering == "problematic":
    node1 = 11
    node2 = 111
...
ops.node(node2, 0.00, 0.00, 3.12, '-mass', *[1.420*tonne, 1.420*tonne, 1.420*tonne, 0, 0, 0]) # Node 2

ops.node(node4, 0.25, 0.00, 3.12, '-mass', *[3.906*tonne, 3.906*tonne, 3.906*tonne, 0, 0, 0]) # Node 4 
ops.node(node6, 0.00, 0.20, 3.12, '-mass', *[3.071*tonne, 3.071*tonne, 3.071*tonne, 0, 0, 0]) # Node 6

# ops.node(node4, 0.25, 0.00, 3.12, '-mass', *[0, 0, 0, 0, 0, 0]) # Node 4 
# ops.node(node6, 0.00, 0.20, 3.12, '-mass', *[0, 0, 0, 0, 0, 0]) # Node 6

ops.node(node3, 0.00, 0.00, 3.12, '-mass', *[0, 0, 0, 0, 0, 0]) # Node 3
ops.node(node5, 0.00, 0.00, 3.12, '-mass', *[0, 0, 0, 0, 0, 0]) # Node 5
